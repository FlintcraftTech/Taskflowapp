# [HASH] — ScheduleViewModel.kt `dateLabelFor` — return null for the Tomorrow slot so Tomorrow rows show no date label (redundant with the page title); KDoc updated to match.
